package com.remanero.br.postjson;
...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        switch(view.getId()){
            case R.id.btnPost:
                ...
                //http://localhost:8080/NutricheckerWebService/webresources/nutrichecker/post

                //new HttpAsyncTask().execute("http://10.0.0.102:8080/spring/service/usuario/registerLogin");

                new HttpAsyncTask().execute("http://192.168.25.62:8080//spring/service/usuario/registerLogin");
    ...
    private class HttpAsyncTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... urls) {
            ...
            usuario.setEmail(etCountry.getText().toString());
            usuario.setSenha(etTwitter.getText().toString());
